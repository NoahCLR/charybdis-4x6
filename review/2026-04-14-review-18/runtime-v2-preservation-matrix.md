...
| Multi-tap | Multi-tap series preserve authored tap chains, delayed action flush, pending-hold promotion, and threshold/long-hold behavior. | `docs/INTERACTION_MODEL.md` | `tests/host/run_key_runtime_release_matrix_tests.sh`, `tests/host/run_key_runtime_scenario_tests.sh`, `tests/host/run_runtime_debug_tests.sh` |
