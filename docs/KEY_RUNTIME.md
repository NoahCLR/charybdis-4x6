...
| [`core/runtime.h`](../users/noah/lib/key/runtime/core/runtime.h), [`core/runtime.c`](../users/noah/lib/key/runtime/core/runtime.c) | Single-authority runtime state, reducer entry points, pending multi-tap scan state, leases, persistent intents, and pending release transport. |
