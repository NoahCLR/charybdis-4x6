...
- Generated color swatches: `./profile-introspection-assets/profile-color-swatch-*.svg`
- Regenerate the report, layer images, and swatches with `python3 tools/profile_introspect.py --write`
