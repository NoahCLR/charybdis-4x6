...
typedef bool (*pd_mode_key_runtime_capture_pending_multi_tap_hold_t)(void *context, uint16_t *tap_action, uint16_t *hold_action);
...
typedef struct {
    ...
    pd_mode_key_runtime_capture_pending_multi_tap_hold_t   capture_pending_multi_tap_hold;
