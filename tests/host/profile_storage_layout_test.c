...
int main(void) {
    if (DYNAMIC_KEYMAP_EEPROM_MAX_ADDR != 0x1FFFu || NOAH_PROFILE_STORAGE_SLOT_A_SIZE != 4096u || NOAH_PROFILE_STORAGE_SLOT_B_SIZE != 4096u || NOAH_PROFILE_STORAGE_SLOT_PAYLOAD_MAX != 4064u || NOAH_PROFILE_STORAGE_VIA_MACRO_SIZE != 7191u || NOAH_PROFILE_WIRE_V1_LED_BITMAP_SIZE != 8u) {
        return 1;
    }
