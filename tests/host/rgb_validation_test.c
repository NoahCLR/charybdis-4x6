...
const pd_mode_def_t pd_modes[PD_MODE_COUNT] = {
    ...
    [PD_MODE_INDEX_VOLUME] = {.mode_flag = PD_MODE_VOLUME, .keycode = VOLUME_MODE},
    [PD_MODE_INDEX_BRIGHTNESS] = {.mode_flag = PD_MODE_BRIGHTNESS, .keycode = BRIGHTNESS_MODE},
    [PD_MODE_INDEX_ZOOM] = {.mode_flag = PD_MODE_ZOOM, .keycode = ZOOM_MODE},
    [PD_MODE_INDEX_ARROW] = {.mode_flag = PD_MODE_ARROW, .keycode = ARROW_MODE},
    [PD_MODE_INDEX_PINCH] = {.mode_flag = PD_MODE_PINCH, .keycode = PINCH_MODE},
};
