...
static const uint8_t ordered_domain_ids[2] = {NOAH_PROFILE_DOMAIN_V1_RGB, NOAH_PROFILE_DOMAIN_V1_KEY_BEHAVIORS};
...
static bool domain_version_is_known(uint8_t id, uint8_t version) {
    return (id == NOAH_PROFILE_DOMAIN_V1_RGB && version == NOAH_PROFILE_DOMAIN_V1_RGB_VERSION) || (id == NOAH_PROFILE_DOMAIN_V1_KEY_BEHAVIORS && version == NOAH_PROFILE_DOMAIN_V1_KEY_BEHAVIOR_VERSION);
}

static bool domain_id_is_known(uint8_t id) {
    return id == NOAH_PROFILE_DOMAIN_V1_RGB || id == NOAH_PROFILE_DOMAIN_V1_KEY_BEHAVIORS;
}
