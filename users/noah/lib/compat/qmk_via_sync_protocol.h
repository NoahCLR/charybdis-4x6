...
typedef enum {
    ...
    NOAH_QMK_VIA_SYNC_MESSAGE_LOGICAL_STAGE_BEGIN  = 8,
    NOAH_QMK_VIA_SYNC_MESSAGE_LOGICAL_STAGE_VERIFY = 9,
    NOAH_QMK_VIA_SYNC_MESSAGE_LOGICAL_STAGE_ACCEPT = 10,
    NOAH_QMK_VIA_SYNC_MESSAGE_LOGICAL_STAGE_ABORT  = 11,
