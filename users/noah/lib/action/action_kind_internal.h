...
#define NOAH_ACTION_KIND_MATCH_DECL(name, priority, matcher, caps, keeps_feedback, preview_uses_desc_layer, dispatch_flags, policy_flags, tap_impl, press_impl, release_impl) \
