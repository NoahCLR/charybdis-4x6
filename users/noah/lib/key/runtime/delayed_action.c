...
void dispatch_delayed_action_at(keypos_t key_pos, uint16_t action, delayed_action_mods_t mods) {
    noah_emit_policy_t policy =
        noah_action_keycode_is_macro(action) ? NOAH_EMIT_POLICY_SETTLE_FALLBACK_HOLDS_AND_PRESERVE_MODS : NOAH_EMIT_POLICY_SETTLE_FALLBACK_HOLDS;
