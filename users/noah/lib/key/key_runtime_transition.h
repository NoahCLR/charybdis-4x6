...
typedef key_runtime_effect_kind_t key_runtime_transition_effect_kind_t;
typedef key_runtime_effect_t      key_runtime_transition_effect_t;

#define KEY_RUNTIME_TRANSITION_EFFECT_NONE KEY_RUNTIME_EFFECT_NONE
#define KEY_RUNTIME_TRANSITION_EFFECT_DISPATCH_ACTION KEY_RUNTIME_EFFECT_DISPATCH_ACTION
#define KEY_RUNTIME_TRANSITION_EFFECT_HELD_ACTION_REGISTER KEY_RUNTIME_EFFECT_HELD_ACTION_REGISTER
#define KEY_RUNTIME_TRANSITION_EFFECT_HELD_ACTION_UNREGISTER KEY_RUNTIME_EFFECT_HELD_ACTION_UNREGISTER
#define KEY_RUNTIME_TRANSITION_EFFECT_RELEASE_OWNED_STATE_BY_KEY KEY_RUNTIME_EFFECT_RELEASE_OWNED_STATE_BY_KEY
#define KEY_RUNTIME_TRANSITION_EFFECT_REPEAT_START KEY_RUNTIME_EFFECT_REPEAT_START
#define KEY_RUNTIME_TRANSITION_EFFECT_LAYER_PRESS KEY_RUNTIME_EFFECT_LAYER_PRESS
#define KEY_RUNTIME_TRANSITION_EFFECT_LAYER_RELEASE KEY_RUNTIME_EFFECT_LAYER_RELEASE
#define KEY_RUNTIME_TRANSITION_EFFECT_FEEDBACK_PULSE KEY_RUNTIME_EFFECT_FEEDBACK_PULSE
#define KEY_RUNTIME_TRANSITION_EFFECT_PD_MODE_LOCK_TAP KEY_RUNTIME_EFFECT_PD_MODE_LOCK_TAP
#define KEY_RUNTIME_TRANSITION_EFFECT_DELAYED_ACTION KEY_RUNTIME_EFFECT_DELAYED_ACTION
